...
# 2024.10.25 v1.2  CN.Wang add RUN', 'RT', 'EQC'to calculate runrate. from 10/24 data use new rule
...
def upsert_data(df, date):
  ...
  try:
      for _, row in df.iterrows():
          ...
          MERGE INTO ntcent_daily_runtime AS target
